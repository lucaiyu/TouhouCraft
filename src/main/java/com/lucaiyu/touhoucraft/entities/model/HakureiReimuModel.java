...
public class HakureiReimuModel extends EntityModel<HakureiReimu> {
	...
	public HakureiReimuModel() {
		...
		head.setTextureOffset(31, 30).addBox(-5.0F, -5.0F, 0.0F, 5.0F, 5.0F, 5.0F, 0.0F, false);
		...
		hair_r2.setRotationPoint(0.0F, 0.0F, 0.0F);
		...
		rope_r1.setRotationPoint(0.0F, 0.0F, 0.0F);
		...
		rope_r3.setRotationPoint(0.0F, 0.0F, 0.0F);
		...
		rope_r4.setRotationPoint(0.0F, 0.0F, 0.0F);
		...
		body.setTextureOffset(31, 20).addBox(-5.0F, 0.0F, -1.0F, 5.0F, 3.0F, 5.0F, 0.0F, false);
		body.setTextureOffset(27, 12).addBox(-6.0F, 4.0F, -2.0F, 7.0F, 1.0F, 7.0F, 0.0F, false);
		body.setTextureOffset(0, 22).addBox(-7.0F, 5.0F, -3.0F, 9.0F, 1.0F, 9.0F, 0.0F, false);
		body.setTextureOffset(0, 12).addBox(-7.0F, 6.0F, -3.0F, 9.0F, 1.0F, 9.0F, 0.0F, false);
		body.setTextureOffset(0, 0).addBox(-8.0F, 7.0F, -4.0F, 11.0F, 1.0F, 11.0F, 0.0F, false);
		body.setTextureOffset(0, 32).addBox(-5.0F, 3.0F, -2.0F, 5.0F, 1.0F, 6.0F, 0.0F, false);
		...
		leftleg.setTextureOffset(0, 5).addBox(-1.0F, 8.0F, 0.0F, 2.0F, 3.0F, 2.0F, 0.0F, false);

		rightleg = new ModelRenderer(this);
		rightleg.setRotationPoint(0.0F, 24.0F, 0.0F);
		rightleg.setTextureOffset(0, 0).addBox(-5.0F, 8.0F, 0.0F, 2.0F, 3.0F, 2.0F, 0.0F, false);
	}

	@Override
	public void setRotationAngles(HakureiReimu entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
	}
