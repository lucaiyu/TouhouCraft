...
public class OreGeneration {
    public static void generateOres(final BiomeLoadingEvent event){
        oreGenerate(event.getGeneration(), OreFeatureConfig.FillerBlockType.NATURAL_STONE, BlockRegistry.touhou_crystal_ore.get().defaultBlockState(), 1, 6, 0, 7, 1);
        ...
        oreGenerate(event.getGeneration(), OreFeatureConfig.FillerBlockType.NATURAL_STONE, BlockRegistry.magic_ore_in_nether.get().defaultBlockState(), 2, 30, 0, 31, 1);
    }
